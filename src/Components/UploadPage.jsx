...
export default function UploadPage({Uploader}){
    let BookObjectModel = {  
        Title: "",
        Price: 0,
        Author: "",
    ...
    return(
        <div id="Uploadpage">
            <p className="largeText">Upload a Book</p>
            <form>
                ...
                <div className="btnBox">
                    <button className="btn redBtn" onClick={clearForm}>Clear</button>
                    <button className="btn blueBtn" onClick={submitForm}>Submit</button>
                </div>
            </form>
        </div>
    );
